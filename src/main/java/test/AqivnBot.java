...
public class AqivnBot extends BotHandler {
	...
	private String getAqi() {
		return getWebPage("http://www.aqivn.org/en/").map(this::documentToAqiString).toBlocking().first();
	}
	...
	public static void main(String[] args) throws IOException {
		...
		bot.getWebPage("http://www.aqivn.org/en/").map(bot::documentToAqiString).subscribe(str -> {
